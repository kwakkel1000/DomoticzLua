...
-- BADKAMER
if (not glib.timerOn(6,30 , 9,30 , tonumber(hour),tonumber(minute) ,{'S Badkamerfan'}) and not glib.timerOn(22,30 , 23,45 , tonumber(hour),tonumber(minute) ,{'S Badkamerfan'})) then
